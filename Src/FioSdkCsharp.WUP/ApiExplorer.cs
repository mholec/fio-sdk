...
namespace FioSdkCsharp
{
    public class ApiExplorer
    {
        ...
        /// </summary>
        public async Task<AccountStatement> Last()
        {
        ...
        /// </summary>
        public async Task<string> Periods(TransactionFilter filter, Format format)
        {
        ...
        /// </summary>
        public async Task<string> Last(Format format)
        {
        ...
        /// </summary>
        public async Task SetLastDownloadDate(DateTime date)
        {
